...
export default function Athletes() {
    ...
    try {
      ...
      if (newAthletesData) {
        ...
        if (formImage) {
          ...
          const uploadImage = await uploadImageAthlete(
            newAthletesData.id,
            formData
          );
  ...
  return (
    <>
      ...
      <div className="m-3">
        <div className="row">
          ...
          <div className="input-group w-50 col-lg w-100">
            <input
              type="text"
              className="form-control bg-dark-custom-input "
              placeholder="Buscar"
              aria-label="Search"
      ...
      <AthletesList
        newAthlete={newAthlere}
        inputFilter={inputFilter}
        searchFilter={clickCount}
      />
      <Modal
        ...
        <Box sx={style}>
          <div className="d-flex justify-content-between">
            ...
            <FontAwesomeIcon
              ...
              size="xl"
              onClick={handleCloseCreateAthlete}
            />
          </div>
          <hr />
          <div className="row" style={{ height: "520px" }}>
            ...
            <div className="d-flex flex-column align-content-center justify-content-center col-md-7">
              ...
              <div className="input w-100 mt-2">
                ...
                <select
                  ...
                  name="posicao_primaria"
                  value={formData.posicao_primaria}
                  onChange={handleInputChange}
                  style={{
                    height: "45px",
                    color: formData.posicao_primaria ? "#fff" : "#999",
                  }}
                >
                  ...
                  <option value={11} style={{ color: "#fff" }}>
                    EXTREMO DIREITO
                  </option>
                  <option value={12} style={{ color: "#fff" }}>
                    EXTREMO ESQUERDO
                  </option>
                </select>
              </div>
              <div className="input w-100 mt-2">
                ...
                <select
                  ...
                  style={{
                    height: "45px",
                    color: formData.posicao_secundaria ? "#fff" : "#999",
                  }}
                >
              ...
              <div className="input w-100 mt-2">
                ...
                <select
                  className="form-select"
                  name="posicao_terciaria"
                  value={formData.posicao_terciaria || ""}
                  onChange={handleInputChange}
                  style={{
                    height: "45px",
                    color: formData.posicao_terciaria ? "#fff" : "#999",
                  }}
                >
                  <option value={1} style={{ color: "#fff" }}>
                    NENHUM
            ...
            <div
              className="ms-3 d-flex flex-column mt-3 pb-3"
              style={{ width: "98%" }}
            >
              <button
                type="button"
